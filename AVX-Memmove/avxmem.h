...
void * AVX_memmove(void *dest, const void *src, size_t numbytes);
void * AVX_memcpy(void *dest, const void *src, size_t numbytes);
...
void * memmove_large(void *dest, const void *src, size_t numbytes);
void * memmove_large_a(void *dest, const void *src, size_t numbytes);
void * memmove_large_as(void *dest, const void *src, size_t numbytes);

void * memmove_large_reverse(void *dest, const void *src, size_t numbytes);
void * memmove_large_reverse_a(void *dest, const void *src, size_t numbytes);
void * memmove_large_reverse_as(void *dest, const void *src, size_t numbytes);
...
void * memcpy_large(void *dest, const void *src, size_t numbytes);
void * memcpy_large_a(void *dest, const void *src, size_t numbytes);
void * memcpy_large_as(void *dest, const void *src, size_t numbytes);
